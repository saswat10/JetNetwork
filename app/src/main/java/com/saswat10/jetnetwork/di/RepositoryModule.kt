...
import com.saswat10.jetnetwork.data.OnlineStatusRepositoryImpl
...
abstract class RepositoryModule {
    ...
    @Binds abstract fun bindsOnlineStatusRepository(impl: OnlineStatusRepositoryImpl): OnlineStatusRepository
}
